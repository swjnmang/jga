#!/usr/bin/env python3
"""Add distractors to all sport/religion cards in triviaExtraCards.ts"""
import re

# Sport & Recreation Distractors
sport_distractors = {
...
# Religion & Belief Distractors (all have "religionglaube-" prefix)
religion_distractors = {
...
# Merge all distractors
all_distractors = {**sport_distractors, **religion_distractors}
...
print(f"✓ Added distractors to {count}/{len(all_distractors)} cards in triviaExtraCards.ts")
